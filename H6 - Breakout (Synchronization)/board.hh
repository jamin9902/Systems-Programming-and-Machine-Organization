...
struct pong_board {
    ...
    std::mutex* m_rows;               // mutexes for rows
...
struct pong_ball {
    ...
    std::condition_variable_any block;    // ball condition variable
...
struct pong_warp {
    ...
    std::mutex m_warp;                            // warp_mutex
    std::condition_variable_any block_warp;       // warp condition variable
    std::queue<pong_ball*> ball_queue;            // more than one ball in warp
